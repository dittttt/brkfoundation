...
with open('src/layouts/AdminLayout.tsx', 'r', encoding='utf-8') as f:
    text = f.read()

layout_code_new = '''  return (
...
old_return_block = text[text.find('  return (\n    <div className="flex min-h-screen bg-gray-50">'):]
text = text.replace(old_return_block, layout_code_new)

with open('src/layouts/AdminLayout.tsx', 'w', encoding='utf-8') as f:
    f.write(text)
